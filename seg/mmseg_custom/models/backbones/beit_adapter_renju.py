...
# Import the new spatial module
from .adapter_modules_renju import EnhancedCascadedSpatialModule, deform_inputs
from .adapter_modules_renju import InteractionBlockWithCls as InteractionBlock

_logger = logging.getLogger(__name__)


@BACKBONES.register_module()
class BEiTAdapterrenju(BEiT):
    def __init__(self, pretrain_size=224, conv_inplane=64, n_points=4, deform_num_heads=6,
        ...
        # Replace the original SpatialPriorModule with the new EnhancedCascadedSpatialModule
        self.spm = EnhancedCascadedSpatialModule(inplanes=conv_inplane, embed_dim=embed_dim, with_cp=with_cp)
    ...
    def forward(self, x):
        ...
        # SPM forward (now using the enhanced module)
